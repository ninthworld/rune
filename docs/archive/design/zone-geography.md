...
- Introducing a new zone (a sideboard, a companion area, an "outside the game" surface)
  ...
  `sage-protocol` shape, the TypeScript mirror, `docs/protocol.md`, and a rack variant that
...
Each closes through a protocol PR that updates `sage-protocol`, the TypeScript
