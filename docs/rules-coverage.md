...
| CR 508.1 / 508.1a / 508.1f | Declare attackers: the active player declares as attackers untapped creatures controlled since the turn began; declaring none is legal; attacking taps the attacker. | partial — declaration only; single attack target (the opponent), no vigilance/defender. Combat damage lands separately (CR 510, below). | `combat.rs :: attacker_candidates`, `actions.rs :: attackers_selection_is_legal`, `apply.rs :: apply_declare_attackers` | `apply.rs :: issue_117_declare_attackers_taps_and_marks_attackers_cr_508_1`, `apply.rs :: issue_117_empty_attacker_declaration_is_legal_cr_508_1a`, `apply.rs :: issue_117_tapped_creature_cannot_attack_cr_508_1a` |
| CR 509.1 / 509.1a | Declare blockers: the defending player assigns each blocker to one attacking creature; multiple blockers per attacker are allowed; a tapped creature can't block. | partial — declaration only (no blocking restrictions beyond untapped, no player-chosen damage-assignment order). Combat damage lands separately (CR 510, below). | `combat.rs :: blocker_candidates`, `combat.rs :: declared_attackers`, `actions.rs :: blocks_selection_is_legal`, `apply.rs :: apply_declare_blockers` | `apply.rs :: issue_117_defender_declares_blockers_multiple_per_attacker_cr_509_1a`, `apply.rs :: issue_117_tapped_creature_cannot_block_cr_509_1a`, `apply.rs :: issue_117_a_creature_cannot_be_declared_as_two_blocks_cr_509_1a` |
