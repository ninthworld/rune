...
//! same identity can never disagree (ADR 0008 §7). The formats are projected from the
...
use sage_engine::{CardData, CardDatabase, CardId};
use sage_protocol::{CatalogCard, CatalogFormat, CatalogView, CATALOG_VERSION};
...
mod tests {
    ...
    use sage_engine::{scripted_rules_text, FunctionalId};
