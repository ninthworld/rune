...
/// [`apply_pass_priority`](rune_engine::apply_action) itself applies, read from the
...
mod tests {
    ...
    fn pass_label(view: &rune_protocol::GameView) -> &str {
        view.valid_actions
            .iter()
    ...
    fn issue_554_a_cast_names_the_stack() {
        ...
        state.players[0].mana_pool.add(rune_engine::Color::Black, 3);
