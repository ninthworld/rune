...
mod tests {
    ...
    fn bundled_printings_load_from_the_set_manifest() {
        ...
        // M19 prints one hundred and eleven of the catalog's cards at their real
        // collector numbers; PM19 reprints one — 112 printings total. The catalog's one
        // non-M19 definition (the commander fixture, ADR 0009) has no printing here.
        assert_eq!(printings.len(), 112);
