...
//! [`sage_server::Room`], and the winning line runs *through the commander-specific
...
//! — filling slots with [`sage_cli::fill_answers`], exactly what the socket loop sends
